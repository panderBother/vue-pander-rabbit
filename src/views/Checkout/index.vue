<script setup>
import { getOrderInfo,submitOrder } from '@/apis/order'
...
<template>
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="isShowAddress = true">切换地址</el-button>
  ...
  <!-- 切换地址 -->
   <el-dialog title="切换收货地址" width="30%" center v-model="isShowAddress">
  <div class="addressWrapper">
    <div class="text item" :class="{active:activeAddress.id===item.id}" v-for="item in checkInfo.userAddresses" @click="changeAddress(item)"  :key="item.id">
      <ul>
  ...
  <template #footer>
    <span class="dialog-footer">
      <el-button @click="isShowAddress=false">取消</el-button>
